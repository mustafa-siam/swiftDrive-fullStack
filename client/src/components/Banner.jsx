...
const Banner = () => {
    return (
        ...
        className="flex flex-col md:flex-row justify-between  gap-12 px-2 md:px-7 md:py-12 py-3 rounded-2xl overflow-hidden  bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-auto space-y-12 p-2">
