...
const Footer = () => {
    return (
          ...
          transition={{duration:0.6 ,delay:0.3}}
                    className='flex gap-2 text-black font-semibold text-2xl'><img src={assets.logo} alt="" /> SwiftDrive</motion.p>
          ...
          transition={{duration:0.6 ,delay:0.8}}
                >
                    <p className='text-lg text-gray-800 font-medium'>RESOURCES</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
